...
The code is highly specific and is only applicable to Laue single-crystal neutron-diffraction data from imaging-plate or other "storage" detectors. In particular, it cannot be used with time-of-flight data from a spallation source. The code runs under MS Windows, though emulation on other systems are said to work.
